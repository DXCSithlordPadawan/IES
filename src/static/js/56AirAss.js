...
function displayHelp() {
    console.log('🪖 56th Guards Air Assault Brigade Database Management Tool');
    console.log('=========================================================\n');
...
function runDiagnostics() {
    console.log('🔧 Running 56AirAss.js Diagnostic Checks');
    console.log('========================================\n');
...
function add56thGuardsAirAssaultBrigade() {
    ...
    const guardsAirAssaultBrigade = {
        ...
        "names": [
            ...
            {
                "value": "56-я гвардейская десантно-штурмовая бригада",
                "language": "ru",
                "nameType": "official"
            },
            {
    ...
    const existingUnit = data.militaryUnits.find(u => 
        ...
        (u.names && u.names.some(name => 
            ...
            name.value.includes('56-я гвардейская десантно-штурмовая бригада')
        ))
    );
    
    if (existingUnit) {
        console.log(`ℹ️ 56th Guards Air Assault Brigade already exists in ${OPERATION_CONFIG.displayName} database. Updating...`);
    ...
    console.log(`✅ Successfully added 56th Guards Air Assault Brigade to ${OPERATION_CONFIG.displayName}`);
    console.log('📁 File location:', filePath);
    console.log('🆔 Added unit ID:', guardsAirAssaultBrigade.id);
    console.log('🏷️ Unit type added:', airAssaultBrigadeType.id);
...
function remove56thGuardsAirAssaultBrigade() {
    ...
    try {
        ...
        // Report results
        if (removedCount > 0) {
            console.log(`✅ Successfully removed ${removedCount} 56th Guards Air Assault Brigade record(s) from ${OPERATION_CONFIG.displayName}`);
            if (removedUnitType) {
                console.log('✅ Also removed air-assault-brigade unit type (no other air assault brigades found)');
            }
        } else {
            console.log(`ℹ️ No 56th Guards Air Assault Brigade records found to remove from ${OPERATION_CONFIG.displayName}`);
        }
        ...
        if (error.code === 'ENOENT') {
            ...
            console.error('❌ Error removing 56th Guards Air Assault Brigade:', error.message);
        }
        return false;
    }
}
...
function verifyFileStructure() {
    ...
    try {
        ...
        if (data.militaryUnits) {
            data.militaryUnits.forEach(unit => {
                if (unit.names && unit.names.some(name => 
                    ...
                    name.value.toLowerCase().includes('56-я гвардейская десантно-штурмовая')
                )) {
                    remainingRefs++;
        ...
        if (remainingRefs === 0) {
            console.log('✅ No remaining 56th Guards Air Assault Brigade references found');
        }
...
async function performAddOperation() {
    console.log(`🚀 Adding 56th Guards Air Assault Brigade to ${OPERATION_CONFIG.displayName} database...\n`);
    ...
    try {
        ...
        if (refreshSuccess) {
            ...
            console.log(`   ✅ 56th Guards Air Assault Brigade added to ${OPERATION_CONFIG.displayName}`);
...
async function performRemoveOperation() {
    console.log(`🚀 Removing 56th Guards Air Assault Brigade from ${OPERATION_CONFIG.displayName} database...\n`);
    ...
    try {
        ...
        if (refreshSuccess) {
            ...
            console.log(`   ✅ 56th Guards Air Assault Brigade removed from ${OPERATION_CONFIG.displayName}`);
            console.log('   ✅ Database reloaded in web interface');
            console.log('   ✅ Analysis refreshed with updated data');
            console.log('   ✅ Cache cleared');
            console.log('\n🌐 You can now view the updated data in your web browser');
            console.log('💡 The 56th Guards Air Assault Brigade should no longer appear in any analysis');
        } else {
            console.log('\n⚠️ Partial success:');
            console.log(`   ✅ 56th Guards Air Assault Brigade removed from ${OPERATION_CONFIG.displayName}`);
            console.log('   ✅ Database reloaded in web interface');
...
if (require.main === module) {
    ...
    try {
        ...
        try {
            ...
            console.log('\n💡 Try running: node 56AirAss.js --diagnostic');
            process.exit(1);
        }
